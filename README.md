...
> [!NOTE]
> ### 💎 Cập Nhật Mới Tại Phase 7 (Unified NLU & Deep Search & Infra)
> * **Food Recommendation Service V2**: Sử dụng Unified NLU LLM tự động xác định ngữ cảnh vị trí, nếu thiếu thông tin sẽ trả UI Form bản đồ. Hỗ trợ ranking dựa trên khoảng cách, ETA, giá cả, và tạo câu trả lời tự nhiên qua Food Answer LLM.
> * **Tối ưu Hóa Đánh Giá (Benchmark Asynchronous)**: Chuyển đổi công cụ Benchmark sang tiến trình nền (background polling) giúp vượt qua giới hạn timeout 100s của Railway, đảm bảo chạy ổn định khi đánh giá 50+ case.

---

## ⚡ Sơ Đồ Mermaid Luồng Xử Lý Phase 9

Hệ thống triển khai kiến trúc **NLU-Gateway RAG (Phase 6)** tiên tiến nhất hiện nay với tốc độ xử lý siêu tốc, tự động nhận biết intent để rẽ nhánh sang luồng RAG hoặc Food Recommendation:
