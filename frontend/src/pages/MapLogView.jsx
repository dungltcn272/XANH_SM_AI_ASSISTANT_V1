...
import { Search, Copy, Download, ChevronDown, ChevronRight, Check, X, Box, Target, Clock, Activity, Cpu, Database } from 'lucide-react';
import { api } from '../api';

export default function MapLogView() {
  ...
  useEffect(() => {
    const fetchLogs = async () => {
      ...
      try {
        ...
        const data = await api.getMapLogs(skip, pageSize, date);
        setLogs(data?.items || []);
