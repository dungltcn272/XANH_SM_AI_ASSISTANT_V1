export const PRESENTATION_SLIDES = [
  ...
  {
    id: "nlu_fast_path",
    title: "3. NLU Fast-Path & Multimodal",
    subtitle: "Định tuyến Siêu tốc & Xử lý Ảnh",
    strategy: "Chạy Micro-checks để Bypass LLM nếu câu hỏi rõ ràng. ĐẶC BIỆT: Nếu có hình ảnh, NLU lập tức đóng vai trò thị giác máy tính đọc hiểu ảnh và 'dịch' thành văn bản chi tiết, sau đó hủy ảnh để bảo vệ luồng Generator.",
    tech: "Rule-based Intent Classifier, Multimodal Vision, Bypass LLM",
    benefits: "Tiết kiệm 1-2s độ trễ cho câu hỏi thường. Với luồng Ảnh (Multimodal), tiết kiệm hàng ngàn Token và chặn đứng lỗi định dạng.",
